(() => {
  ...
  function surfaceFromCloseTarget(target) {
    ...
    if (target.closest?.('[data-rp-profile-settings], .rp-profile-settings-placeholder')) return target.closest('[data-rp-profile], .rp-public-player-profile, [data-rp-public-profile]');
    ...
    if (target.closest?.('[data-rp-recognition-close]')) return target.closest('[data-rp-recognition-modal]');
  ...
  document.addEventListener('click', (event) => {
    ...
    const recognition = document.querySelector('[data-rp-recognition-modal]');
    if (event.target === recognition && recognition?.classList.contains('open')) {
      releaseFocus(recognition);
      return;
    }
  ...
  window.addEventListener('keydown', (event) => {
    ...
    const surfaces = [
      ...
      document.querySelector('[data-rp-recognition-modal].open'),
