(() => {
  ...
  function ensureStyle() {
    ...
    style.textContent = `
      ...
      .rp-4v4-info-panel[data-rp-4v4-info-panel="ovr"]{width:min(100%,390px);margin-inline:auto;text-align:center}.rp-4v4-info-panel[data-rp-4v4-info-panel="ovr"] .rp-4v4-info-copy{max-width:340px;margin-inline:auto}
