    ...
    backdrop.innerHTML = `
      <section class="rp-4v4-info-sheet" role="dialog" aria-modal="true" aria-labelledby="rp-4v4-info-title">
        ...
        <div class="rp-4v4-info-body">
          ...
          <section class="rp-4v4-info-panel" data-rp-4v4-info-panel="balance" hidden>
            <p class="rp-4v4-info-kicker">TEAM BALANCING</p><h3 class="rp-4v4-info-title">HOW THE BALANCE RANGE IS SET</h3>
            <p class="rp-4v4-info-copy">Once all four teams have 5 valid rostered players, Real Play averages all 20 player OVRs. That average becomes the Target OVR. The balanced range is Target ±2.</p>
            <div class="rp-4v4-info-card"><strong data-rp-4v4-balance-title>SAMPLE BALANCE RANGE</strong><div class="rp-4v4-balance-range"><div class="rp-4v4-balance-stat"><small>LOWER</small><b data-rp-4v4-balance-lower>69</b></div><div class="rp-4v4-balance-stat target"><small>TARGET</small><b data-rp-4v4-balance-target>71</b></div><div class="rp-4v4-balance-stat"><small>UPPER</small><b data-rp-4v4-balance-upper>73</b></div></div><p class="rp-4v4-balance-status" data-rp-4v4-balance-status>Sample range until all four 5-player rosters are complete.</p></div>
            <div class="rp-4v4-info-card"><strong>WHAT THE LIMITS MEAN</strong><p>Below the Lower threshold means a team may be underpowered. Above the Upper threshold means a team may be too stacked. Teams inside the range are considered balanced for the current player pool.</p></div>
          </section>
        </div>
      </section>`;
