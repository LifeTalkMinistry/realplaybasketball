(() => {
  ...
  function premiumBar({
    ...
    return dataUrl(`
      <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1000 140" preserveAspectRatio="none">
        ...
        <!-- full outer frame -->
        <path d="M12 70L31 36L48 20L117 12L153 19L182 18H819L851 20L929 14L974 30L990 48L976 70L990 92L974 110L929 126L851 120L819 122H182L153 121L117 128L48 120L31 104Z"
          fill="url(#outer)"/>
        <path d="M17 70L35 39L52 24L118 17L153 24L181 23H821L852 25L927 20L968 34L983 49L970 70L983 91L968 106L927 120L852 115L821 117H181L153 116L118 123L52 116L35 101Z"
          fill="${innerA}" stroke="${edge}" stroke-opacity=".82" stroke-width="2.1"/>

        <!-- bevel shell -->
        <path d="M26 70L43 42L58 30L123 23L155 30H824L855 31L924 27L959 39L972 51L961 70L972 89L959 101L924 113L855 109L824 110H155L123 117L58 110L43 98Z"
          fill="url(#bevel)" opacity=".68"/>
        <path d="M34 70L50 46L64 36L127 29L159 36H822L852 37L920 33L950 43L961 53L952 70L961 87L950 97L920 107L852 103L822 104H159L127 111L64 104L50 94Z"
          fill="url(#inner)"/>

        <!-- left rank socket -->
        <path d="M24 70L41 39L55 27L116 20L148 29L132 70L148 111L116 120L55 113L41 101Z"
          fill="url(#socket)" stroke="${edge}" stroke-opacity=".95" stroke-width="2.25"/>
        <path d="M38 70L52 46L63 38L109 33L130 39L120 70L130 101L109 107L63 102L52 94Z"
          fill="${socketDeep}" stroke="${rail}" stroke-opacity=".88" stroke-width="1.45"/>
        <path d="M45 70L58 50L68 43L105 39L121 44L114 70L121 96L105 101L68 97L58 90Z"
          fill="${innerA}" stroke="${edgeSoft}" stroke-opacity=".46" stroke-width="1"/>
        ...
        <!-- center horizontal chamber -->
        <path d="M151 35L174 38H828L855 38L916 34L944 43L953 53L945 70L953 87L944 97L916 106L855 102L828 102H174L151 105L161 70Z"
          fill="${innerA}" fill-opacity=".58"/>
        ...
        <!-- recognition badge socket / light pocket -->
        ...
        <!-- right OVR cap -->
        <path d="M921 28L960 39L974 52L964 70L974 88L960 101L921 112L938 87L932 70L938 53Z"
          fill="url(#ovr)" stroke="${edge}" stroke-opacity=".74" stroke-width="1.5"/>
  ...
  const bars = Object.freeze({
    most_overall_mvp: premiumBar({
      outerA:'#1b1000', outerB:'#8d5800', outerC:'#503000',
      innerA:'#090500', innerB:'#2b1900', innerC:'#4c2d00',
      edge:'#ffd95f', edgeSoft:'#fff0a8', rail:'#d79600', railSoft:'#7c4d00',
      glow:'#ffc834', socket:'#684000', socketDeep:'#100900', ovr:'#4a2d00',
    }),
    most_team_mvp: premiumBar({
      outerA:'#061527', outerB:'#2f78b9', outerC:'#163f70',
      innerA:'#020913', innerB:'#091a2d', innerC:'#103154',
      edge:'#d6f3ff', edgeSoft:'#8bd8ff', rail:'#5bbcff', railSoft:'#275c8d',
      glow:'#62c6ff', socket:'#123c64', socketDeep:'#030b15', ovr:'#153b5d',
    }),
    best_shooting: premiumBar({
      outerA:'#03171d', outerB:'#0d88a4', outerC:'#075565',
      innerA:'#01090d', innerB:'#062027', innerC:'#0a3641',
      edge:'#d4fbff', edgeSoft:'#70efff', rail:'#32d5ea', railSoft:'#157181',
      glow:'#49eaff', socket:'#0b4f5e', socketDeep:'#020c10', ovr:'#0c4755',
    }),
    best_rebounder: premiumBar({
      outerA:'#06142c', outerB:'#315fa8', outerC:'#173a73',
      innerA:'#020715', innerB:'#07162b', innerC:'#102a55',
      edge:'#dce9ff', edgeSoft:'#8cb8ff', rail:'#5a87ff', railSoft:'#294b8c',
      glow:'#658dff', socket:'#173d78', socketDeep:'#030919', ovr:'#173964',
    }),
    captain_eligible: premiumBar({
      outerA:'#03111f', outerB:'#0f77b5', outerC:'#07486f',
      innerA:'#010811', innerB:'#061724', innerC:'#0a2d49',
      edge:'#c9f7ff', edgeSoft:'#78e6ff', rail:'#20cfff', railSoft:'#0b6694',
      glow:'#33bfff', socket:'#0a4165', socketDeep:'#020a12', ovr:'#0b3653',
    }),
  });
  ...
  function applyVectorAuthority(root = document) {
    ...
    rows.forEach((row) => {
      ...
      if (
        row.style.getPropertyValue('--rp-recognition-bar') === value &&
        row.style.getPropertyPriority('--rp-recognition-bar') === 'important'
      ) return;
  ...
  document.addEventListener('click', (event) => {
    if (event.target.closest?.('[data-player-sort]')) {
